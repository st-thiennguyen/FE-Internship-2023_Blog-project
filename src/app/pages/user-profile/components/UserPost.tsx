...
const posts: PostModel[] = [
  {
    id: 74,
    title: 'Hướng dẫn ăn cơm bằng thìa',
    description: 'Em ăn cơm chưa? Em ăn cơm chưa? Em ăn cơm chưa? Em ăn cơm chưa? Em ăn cơm chưa?',
    content:
      'Nếu bạn đang buồn, hãy vui lên. Nếu bạn đang buồn, hãy vui lên. Nếu bạn đang buồn, hãy vui lên. Nếu bạn đang buồn, hãy vui lên. Nếu bạn đang buồn, hãy vui lên. Nếu bạn đang buồn, hãy vui lên',
    status: 'public',
    tags: ['Mẹo vặt cột sống'],
    userId: 132,
    likes: 2,
    comments: 6,
    cover: 'https://ibb.co/sW6fYBH',
    recommend: true,
    deletedAt: null,
    createdAt: '2023-09-18T15:18:57.828Z',
  ...
  },
  {
    ...
    recommend: true,
    deletedAt: null,
    createdAt: '2023-09-18T13:56:57.202Z',
